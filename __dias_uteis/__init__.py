...
def last_du(
    date: Optional[datetime.date] = None, raise_error_not_du: bool = True
) -> datetime.date:
    """
    ...
    """
    return _business_days_default.last_bd(date, raise_error_not_du)
...
def next_du(
    ...
    """
    return _business_days_default.next_bd(date, raise_error_not_du)
